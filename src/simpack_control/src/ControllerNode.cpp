...
: Node("controller_node", options),
  dt_(0.002),
  wheelRadius_(0.43),
  trajLeft_ ({0.0, 3.0, 6.0, 100.0}, {16.667 * 2, 16.667 * 2, 16.708 * 2, 16.708 * 2}), //  trajLeft_ ({0.0, 3.0, 6.0, 100.0}, {16.667, 16.667, 16.708, 16.708}),  //16.708=(60.0/3.6)/300.0*(300.0+1.5/2.0)
  trajRight_({0.0, 3.0, 6.0, 100.0}, {16.667 * 2, 16.667 * 2, 16.625 * 2, 16.625 * 2})  //  trajRight_({0.0, 3.0, 6.0, 100.0}, {16.667, 16.667, 16.625, 16.625})   //16.625=(60.0/3.6)/300.0*(300.0-1.5/2.0)
{
  // 初始化 8 个 PID
